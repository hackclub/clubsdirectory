...
import EmbedMapButton from "./EmbedMapButton";
    ...
    >
      ...
      >
        ...
        <Box
          sx={{
            overflow: "hidden",
            background: "linear-gradient(180deg, #FF8C37 0%, #F5F5F4 100%)",
            p: [2, 3],
            height: "100%",
            borderRadius: 16,
          }}
        >
          <Link
            ...
            href={`https://scrapbook.hackclub.com/clubs/${clubOpened?.scrapbook?.scrapbook_id}`}
          >
            <Box style={{ display: "flex", flexDirection: "row" }}>
              ...
              <Icon sx={{ color: "white" }} glyph="external-fill" size={32} />
            </Box>
          </Link>
              ...
              {clubOpened?.scrapbook?.posts?.map((post) => (
                ...
                >
                  ...
                  >
                    <Link
                      style={{ textDecoration: "none" }}
                      href={`https://scrapbook.hackclub.com/${post?.author?.name}`}
                    >
                      <Flex
                        sx={{
                          color: "inherit",
                      ...
                      >
                        ...
                        >
                          ...
                          >
                            {post.publishDate.toLocaleString()}
                          </Text>
                        </Box>
                      </Flex>
                    </Link>
