...
export const Epoch = ({ leaflet }) => (
  <Marker
    ...
    icon={leaflet.icon({
      iconUrl:
        "https://cloud-hx1v4exha-hack-club-bot.vercel.app/0epochhorizontal.svg",
    ...
    <Popup width={250} closeButton={false}>
      ...
      >
        ...
        <Text style={{ marginTop: 2, marginBottom: 2 }}>
          Epoch was a 42 hour social coding event that brought Hack Clubbers
          together to explore the world of coding, unleash their creativity, and
