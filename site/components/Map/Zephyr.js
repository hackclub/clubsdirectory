...
export const Zephyr = ({ pos, leaflet }) => (
  <>
      ...
      <Popup width={250} closeButton={false}>
        <Box>
          ...
          <Text style={{ marginTop: 2, marginBottom: 2 }}>
            Zephyr was a train that traveled across America from Burlington, VT
            to LA, CA, and it also served as the inspiration for a hackathon by
            Hack Club. The train journey spanned over 3,000 miles and passed
            through some of the country's most beautiful landscapes.
            Participants in the Zephyr hackathon were encouraged to draw
            inspiration from the train journey and create innovative projects
    ...
    <Marker
      ...
      icon={leaflet.icon({
        iconUrl:
          "https://cloud-7rqfdiu0t-hack-club-bot.vercel.app/0zephyrend.svg",
        iconSize: [48, 48], // set the size of the icon based on whether the club is selected
      })}
    >
      <Popup width={250} closeButton={false}>
